        ...
        match state {
            ...
            0 => {
                match chars[index] {
                    0x20 => {
                        state = 1;
                    } // Set State to Path State if Character is Space
                    _ => {
                        request_method.push(chars[index] as char);
                    } // Add current char to `request_method`
                }
            ...
            1 => {
                match chars[index] {
                    0x20 => {
                        state = 2;
                    } // Set State to Version State if Character is Space
                    _ => {
                        request_path.push(chars[index] as char);
                    } // Add current char to `request_path`
                }
            ...
            2 => {
                match chars[index] {
                    0x0D => {
                        state = 3;
                    } // Set State to Newline State if Carriage Return
                    0x0A => {
                        state = 4;
                    } // Set State to Header State if Newline
                    _ => {
                        request_version.push(chars[index] as char);
                    } // Add current char to `request_version`
                }
                ...
                match chars[index] {
                    ...
                    _ => {
                        error_response = format!(
                            "Improper Break from Head to Header. Expected '10' not '{}'.",
                            chars[index]
                        );
                        break;
                    } // Log Error if Improper Request is Sent
                }
            ...
            4 => {
                match chars[index] {
                    ...
                    _ => {
                        current_header_label.push(chars[index] as char);
                    }
                }
            ...
            5 => {
                match chars[index] {
                    ...
                    _ => {
                        current_header_value.push(chars[index] as char);
            ...
            6 => {
                match chars[index] {
                    ...
                    _ => {
                        error_response = format!(
                            "Improper Break from Header to Header. Expected '10' not '{}'.",
                            chars[index]
                        );
                        break;
                    } // Log Error if Improper Request is Sent
            ...
            7 => {
                match chars[index] {
                    0x0A => {
                        state = 8;
                    } // Set State to Body State if Newline
                    _ => {
                        error_response = format!(
                            "Improper Break from Header to Body. Expected '10' not '{}'.",
                            chars[index]
                        );
                        break;
                    } // Log Error if Improper Request is Sent
